    ...
    public static class IncomingImageMessageViewHolder<MESSAGE extends MessageContentType.Image>
        ...
        public void onBind(MESSAGE message) {
            ...
            if (image != null && imageLoader != null) {
                imageLoader.loadMessageImage(image, message.getImageUrl(), getPayloadForImageLoader(message));
            }
    ...
    public abstract static class BaseIncomingMessageViewHolder<MESSAGE extends IMessage>
        ...
        public void onBind(MESSAGE message) {
            ...
            if (userAvatar != null) {
                ...
                if (isAvatarExists) {
                    imageLoader.loadAvatar(userAvatar, message.getUser().getAvatar(), null);
                }
            }
        }
