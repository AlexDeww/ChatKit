...
abstract class Style protected constructor(
    ...
    protected fun getDimension(@DimenRes dimen: Int): Int = resources.getDimensionPixelSize(dimen)

    protected fun getColor(@ColorRes color: Int): Int = ContextCompat.getColor(context, color)
