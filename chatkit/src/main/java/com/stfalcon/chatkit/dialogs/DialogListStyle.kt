 ...
 */
class DialogListStyle private constructor(
    context: Context,
    attrs: AttributeSet?
) : Style(context, attrs) {
    ...
    companion object {
        ...
        fun parse(context: Context, attrs: AttributeSet?): DialogListStyle {
            ...
            style.dialogTitleTextStyle = typedArray.getInt(
                R.styleable.DialogsList_dialogTitleTextStyle,
                Typeface.NORMAL
            )
            ...
            style.dialogUnreadTitleTextStyle = typedArray.getInt(
                R.styleable.DialogsList_dialogUnreadTitleTextStyle,
                Typeface.NORMAL
            )
            ...
            style.dialogMessageTextStyle = typedArray.getInt(
                R.styleable.DialogsList_dialogMessageTextStyle,
                Typeface.NORMAL
            )
            ...
            style.dialogUnreadMessageTextStyle = typedArray.getInt(
                R.styleable.DialogsList_dialogUnreadMessageTextStyle,
                Typeface.NORMAL
            )

            //Date text
            style.dialogDateColor = typedArray.getColor(
            ...
            style.dialogDateStyle = typedArray.getInt(
                R.styleable.DialogsList_dialogDateStyle,
                Typeface.NORMAL
            )
            ...
            style.dialogUnreadDateStyle = typedArray.getInt(
                R.styleable.DialogsList_dialogUnreadDateStyle,
                Typeface.NORMAL
            )

            //Unread bubble
            style.isDialogUnreadBubbleEnabled = typedArray.getBoolean(
                R.styleable.DialogsList_dialogUnreadBubbleEnabled,
                true
            )
            ...
            style.dialogUnreadBubbleTextStyle = typedArray.getInt(
                R.styleable.DialogsList_dialogUnreadBubbleTextStyle,
                Typeface.NORMAL
            )
            ...
            style.isDialogMessageAvatarEnabled = typedArray.getBoolean(
                R.styleable.DialogsList_dialogMessageAvatarEnabled,
                true
            )
            ...
            style.isDialogDividerEnabled = typedArray.getBoolean(
                R.styleable.DialogsList_dialogDividerEnabled,
                true
            )
